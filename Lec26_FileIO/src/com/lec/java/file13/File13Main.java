...
public class File13Main {
	...
	public static void main(String[] args) {
		...
		PrintWriter out = null; // 이걸만들어서 파일을 저장
...
//			out = new PrintWriter(bw); // 또 장착~
			out = new PrintWriter(new BufferedWriter(new FileWriter(FILE1))); // 한줄로도 가능
			test_write(out);
			...
			br = new BufferedReader(new InputStreamReader(new FileInputStream(FILE2), "euc-kr")); // 한글 인코딩신경쓰기;
			test_read(br);
			System.out.println();
	...
	public static void test_read(BufferedReader br) { // 읽을떈 버퍼드리더로 쓸떈 프린트롸이터로
		String line;
