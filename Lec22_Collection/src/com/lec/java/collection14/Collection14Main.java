...
public class Collection14Main {
	...
	public static void main(String[] args) throws ParseException {
		...
		System.out.println("Comparable 구현, sort() 적용"); // 대, 소를 구분할려고 comparable
		...
		System.out.println(Collections.min(list3));//comparable이 되있고, 순서에의해서 출력
		...
		Collections.copy(list4, list3);//3->4
		System.out.println(list4);
...
class Student implements Comparable<Student>{ // 먼저 implements하고 오버라이드해서
	String name;
	double point;
	...
	@Override
	public int compareTo(Student o) { // 점수로 할지 이름으로 할지 정한다음에
...
// Student를 이름(name)으로 정렬해줄 수 있는 Comparator<>제공
