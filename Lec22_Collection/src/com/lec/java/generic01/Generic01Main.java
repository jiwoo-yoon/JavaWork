...
public class Generic01Main {
	...
	public static void main(String[] args) {
		...
		FruitBox<Orange> oBox2 = new FruitBox<Orange>(o1);
		oBox2.pullOut().displaySugar();
		
		Apple a1 = new Apple(200);
		FruitBox<Apple> aBox2 = new FruitBox<Apple>(a1);
		aBox2.pullOut().displayWeight();
		
		Banana b1 = new Banana(123);
		FruitBox<Banana> bBox2 = new FruitBox<Banana>(b1);
		bBox2.pullOut().displayNum();
