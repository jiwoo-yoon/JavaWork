...
public class Collection09Main {
	...
	public static void main(String[] args) {
		...
		//subset() 메소드
		//시작값과 끝값을 매개변수로 받아, 그것을 범위(부분) set로 추출
		System.out.println("subset() ~ ");
		TreeSet<Integer> subSet = (TreeSet<Integer>)tset.subSet(5, 14);//5이상 14미만
//		for(Integer s:subSet) {
//			System.out.println(s);
//		}
		System.out.println(subSet); // 오버라이드 다되어있어서 for문 안돌려도댐, list도
