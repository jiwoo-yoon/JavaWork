...
//  두번째 매개변수 : 삭제될 데이터 개수
//  세번째 이후 .. : 삽입될 데이터 들..
fruits.splice(2, 0, "kiwi", "jadu"); //2번부터 0개를 지우고, ""넣는다.
console.log(fruits.toString());

fruits.splice(1, 3, "durian"); //1번부터 3개를 지우고, ""넣는다
console.log(fruits.toString());
...
console.log(fruits.slice(1, 3)) //1부터 3전까지 보여주기
console.log(fruits.slice(1)) //1부터 끝까지 보여주기
