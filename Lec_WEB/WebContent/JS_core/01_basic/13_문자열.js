...
console.log(str1.indexOf("John")) // 못찾으면 -1
...
console.log(str1.slice(7,13)); //7부터 13까지
console.log(str1.slice(-12,-6)); //맨 오른쪽부터 -1 시작
...
console.log(str1.replace("JAPAN", "Korea")); // 대소문자 구분함
console.log(str1.replace(/JAPAN/i, "Korea")); // 정규표현식 대소문자 구분 안하기

str2 = "Please visit Japan! Go Japan";
console.log(str2.replace("Japan", "Korea"));
console.log(str2.replace(/Japan/g, "Korea")); // 정규표현식, global match, 대소문자 구분
