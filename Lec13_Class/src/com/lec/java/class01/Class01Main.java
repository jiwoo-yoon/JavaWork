...
public class Class01Main {
	...
	public static void main(String[] args) {
		...
		//일반적으로 멤버변수는 private 으로 설정하여
		//외부클래스에서 아래와 같이 직접 사용못하게 설계함
//		tv1.isPowerOn = false;
//		tv1.volume = 32;
//		tv1.channel = 24;
		
		MyTv tv2 = new MyTv(); // 다른 인스턴스 생성
		tv2.powerOnOff();
		tv2.channelUp();
		tv2.volumeUp();
		tv2.volumeUp();
		...
		System.out.println();
		tv1=tv2; //tv1이 레퍼런싱하던 인스턴스는 Garbage Collector에 의해 소멸된다.
		tv1.displayStatus();
		tv1.powerOnOff();
		tv2.displayStatus(); //tv1 와 tv2 는 같은 곳을 레퍼런싱하고있다
		System.out.println(tv1);
		System.out.println(tv2);
