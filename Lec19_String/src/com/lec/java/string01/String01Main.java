...
//		System.out.println(str3.length()); //NullPointerException
		...
		String mth = date.split("-")[1];
		String day = date.split("-")[2];
		System.out.println(year + mth + day);
		...
		System.out.println();
		System.out.println("replaceAll(regex, replacement), replaceFirst(regex, replacement)"); // 정규표현식 사용버젼  , replaceAll() 매칭되는것 전부 치환, 
																								// replaceFirst() 첫매칭만 치환
